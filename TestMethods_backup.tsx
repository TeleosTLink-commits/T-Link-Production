...
const SampleInventory: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(err.response?.data?.message || 'Failed to save sample');
    }
  };
                  ...
                  samples.map((sample) => (
                    <tr key={sample.id}>
                      ...
                      <td>
                        ...
                        <br />
                        {sample.has_coa && <span className="badge badge-info" style={{ fontSize: '10px' }}>CoA</span>}
                        {sample.has_dow_sds && <span className="badge badge-info" style={{ fontSize: '10px', marginLeft: '4px' }}>SDS</span>}
                      </td>
                      <td>
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  <label>
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, has_coa: e.target.checked })}
                    />
                    Has Certificate of Analysis (CoA)
                  </label>
                </div>
                ...
                <div className="form-group">
                  <label>
                    <input
                      type="checkbox"
                      checked={formData.has_dow_sds}
                      onChange={(e) => setFormData({ ...formData, has_dow_sds: e.target.checked })}
                    />
                    Has DOW SDS
                  </label>
                </div>
