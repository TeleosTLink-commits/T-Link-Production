...
1. Your email must be in the authorized users list (contact Super Admin)
...
After logging in, you'll see the **T-Link Dashboard** with four main action buttons:
...
3. **Upload Document:** Click **Choose File** to attach the test method PDF
4. Click **Save**
...
4. **HazMat Information** (auto-populated from sample):
   - UN Number
   - Hazard Class
   - Packing Group
...
Click the **Supplies** tab to view and manage shipping supplies:
...
Access from Shipment Logistics → **Supplies** tab

### 7.2 Supply Categories
...
- View role, status, and last login

**Adding Users:**
1. Click **+ Add User**
2. Enter email address
3. Select role (Lab Staff, Admin, Manufacturer)
...
### 8.5 Samples Overview

View all samples in the inventory:
- Chemical name
- Lot number
- Quantity
- Status

### 8.6 Test Methods Overview
...
### 8.7 System Statistics

View database health and statistics:
